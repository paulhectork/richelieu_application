    ...
    <div class="textpage-text-wrapper">
      ...
      <dl>
        ...
        <dd>Paul Kervegan s'occupe de la gestion
          ...
          et du master <q>&nbsp;Technologies numériques appliquées à l'histoire&nbsp;</q>
          de l'École nationale des chartes, il a également collaboré
        ...
        <dd>Loïc Jeanson est actuellement
          ...
          cartographiques dans un SIG et de proposer des possibilités
          de modélisation de données. Docteur de l'université
          de Nantes et de l'École centrale de Nantes, ses travaux
          se situent à l'interface de l'informatique et de l'étude
          patrimoniale.
        </dd>
      </dl>
